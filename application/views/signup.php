...
<!-- Start Midbody -->
		<form action="<?=base_url();?>index.php/signup" method="post">
...
<td>
          <tr ><td>&nbsp;</td>
          <td align="left" class="heading font24">Register Here</span></td>
          </tr>
            ...
            <td align="left"><table width="0" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td ><input name="btnCancel" type="button" value="Cancel" class="btn" /></td>
                       ...
                       <tr>
                    <td></td>
                    <td ><a href="<?=base_url();?>index.php/login/"> Login Here</a></td>
                  </tr>
                </table></td>
          </tr>
